...
class _PredictionScreenState extends State<PredictionScreen> {
  ...
  Future<void> makePrediction() async {
    const String apiUrl =
        "https://medical-insurance-cost-prediction-ndf7.onrender.com/predict";
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        setState(() {
          result = "Predicted Cost: \$${responseData['predicted_insurance_cost'].toStringAsFixed(2)}";
        });
      } else {
        setState(() {
      ...
      setState(() {
        result = "Failed to connect to API";
      });
    }
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text("Insurance Cost Prediction")),
      body: Padding(
        ...
        child: Column(
          children: [
            ...
            DropdownButton<String>(
              ...
              hint: const Text("Smoker?"),
              onChanged: (value) => setState(() => selectedSmoker = value),
              items: ["yes", "no"]
            ...
            DropdownButton<String>(
              ...
              items: ["northeast", "northwest", "southeast", "southwest"]
